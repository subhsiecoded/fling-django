...
SECRET_KEY = "django-insecure-!a($l3qu_s!cfcgyt)q(aug&zw*b&6&6(blfz#4og#asn)o35j"
...
INSTALLED_APPS = [
    "fling", # made an app and setting it here 
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, 'templates')], # now you can have a templates folder in all the django apps where the html files can be stored
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
